...
MENDER_STORAGE_TOTAL_SIZE_MB="${MENDER_STORAGE_TOTAL_SIZE_MB:-32768}"
: "${MENDER_TENANT_TOKEN:?MENDER_TENANT_TOKEN is required — copy it from hosted Mender → Settings → My organization}"
